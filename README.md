...
The intention of this Fork is to fix various issues i personally faced with the original browser. This includes for example:
...
## IMPORTANT NOTE: 
### This Project has absolutely nothing to do with the original. I am just some random person who likes the idea of a minimal browser with the least amount of bloat possible.
